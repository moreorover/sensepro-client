...
# Logging for System arm state check.
logging.basicConfig(
    level=logging.INFO,
...
# The initial state check should be added here, before the main loop.
check_initial_state()
...
try:
    logging.info(
        ...
        f"{lime_green_start}\n\n"  # Start lime green color, two line spaces above
        "   _____                      ____           \n"
    ...
    while True:
        time.sleep(0.1)  # Adds a short sleep to reduce CPU usage
